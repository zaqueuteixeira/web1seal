...
CREATE TABLE IF NOT EXISTS `mydb`.`usuario` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `papel_id` INT NOT NULL DEFAULT 2,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_usuario_perfil_idx` (`papel_id` ASC),
  CONSTRAINT `fk_usuario_perfil`
    FOREIGN KEY (`papel_id`)
    REFERENCES `mydb`.`papel` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tentativas_login`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tentativas_login` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `data` DATE NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`turma_usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`turma_usuario` (
...
-- -----------------------------------------------------
-- Table `mydb`.`questoes_avaliacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`questoes_avaliacao` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb`.`resposta_avaliacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`resposta_avaliacao` (
  ...
  CONSTRAINT `fk_resposta_questoes1`
    ...
    REFERENCES `mydb`.`questoes_avaliacao` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`questoes_atividade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`questoes_atividade` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `mydb`.`resposta_atividade`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`resposta_atividade` (
  `idresposta` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_resposta_avaliacao_copy1_questoes_copy11`
    ...
    REFERENCES `mydb`.`questoes_atividade` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
